...
export function WhatsAppFab({ dict }: { dict: Dictionary }) {
  ...
  return (
    <a
      ...
      className={`fixed z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_4px_14px_rgba(0,0,0,0.25)] transition-[transform,opacity,box-shadow] duration-300 hover:scale-110 hover:shadow-[0_6px_20px_rgba(0,0,0,0.3)] active:scale-95 ${
        visible
